...
beautiful.init("/home/vlad/.config/awesome/themes/idea.lua")
...
awful.util.spawn_with_shell("xrandr --output HDMI2 --mode 1920x1200 --right-of HDMI1")
awful.util.spawn_with_shell("xrandr --output VGA1 --mode 1280x1024 --right-of HDMI2")

awful.util.spawn_with_shell("setxkbmap -layout 'us,ru' -variant ',winkeys,winkeys' -option grp:caps_toggle -option grp_led:caps -option terminate:ctrl_alt_bksp")
...
mymainmenu = awful.menu({ items = { 
		...
		{ "" },
		{"INET", internet_menu},
		{ "Browser", "google-chrome-stable", beautiful.chrome_icon },
		{ "URXvt", "rxvt-unicode" },
		{ "HTop", "rxvt-unicode -e htop" },
...
if action == "+" or action == "-" then
	awful.util.spawn("amixer -q -D pulse set Master 5%" .. action .. " unmute")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ }, "Scroll_Lock", function () awful.util.spawn("i3lock -d -c 000071") end),
    ...
    awful.key({ modkey, "Control" }, "d", function () awful.util.spawn("exo-open --launch FileManager") end),
	--    awful.key({ modkey, "Alt" }, "d", awful.util.spawn("exo-open --launch FileManager")
    ...
    awful.key({ modkey, "Shift"   }, "n", awful.client.restore),
		...
		--awful.key({modkey,	}, "+",	function () awful.util.spawn("amixer -D pulse set Master 5%+ unmute") end),
		--awful.key({modkey,  }, "-",	function () awful.util.spawn("amixer -D pulse set Master 5%- unmute") end),
		...
		awful.key({ modkey,           }, "s",	function () awful.tag.viewonly(awful.tag.gettags(3)[9])	end),
		awful.key({ modkey,           }, "g",	function () awful.tag.viewonly(awful.tag.gettags(2)[9])	end),
                awful.key({ modkey,           }, "v",   function () awful.tag.viewonly(awful.tag.gettags(1)[2]) end),
		...
		awful.key({ modkey,           }, "w",			function () awful.screen.focus_relative(0) end),	
		awful.key({ modkey,           }, "e",			function () awful.screen.focus_relative( 1) end),
                awful.key({ modkey,           }, "q",                   function () awful.screen.focus_relative( 2) end),

		awful.key({ modkey, "Shift"   }, "w",			function (c) awful.client.movetoscreen(c, 0) end),
		awful.key({ modkey, "Shift"   }, "e",			function (c) awful.client.movetoscreen(c,  1) end),
                awful.key({ modkey, "Shift"   }, "q",                   function (c) awful.client.movetoscreen(c,  2) end),
...
awful.util.spawn_with_shell("xautolock -time 5 -locker 'i3lock -d -c 000071'")
