...
--awful.spawn.with_shell("notify-send TEST " .. tostring(geo))
--
...
terminal = host_conf.apps.terminal
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- *****************
    local layouts = host_conf.getLayouts()
...
-- *****************
globalkeys = gears.table.join(globalkeys, host_conf.getHotkeys())
-- *****************
...
-- *****************
awful.rules.rules = host_conf.getClientRules(awful.rules.rules, geo)
-- *****************
...
client.connect_signal("request::titlebars", function(c)
    ...
    awful.titlebar(c, {size=host_conf.titlebar_size}) : setup {
        { -- Left
